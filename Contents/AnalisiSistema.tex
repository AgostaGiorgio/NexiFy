...
\begin{enumerate}
    ...
    \textcolor{red}{traccia video}, nel secondo solo \textcolor{red}{traccia audio}, ma con accompagnamento di
    \textcolor{red}{lyrics} o \textcolor{red}{video musicale};
...
\begin{enumerate}
    ...
    \textcolor{red}{prodotto} \textcolor{violet}{video}, egli \textcolor{teal}{carica} il file video, il file audio e \textcolor{violet}{opzionalmente} sottotitoli.
...
\begin{center}
    \begin{tabular}{ |p{3cm}|p{3cm}|p{3cm}|p{3cm}| }
        ...
        \multicolumn{2}{|p{12cm}|}{Nome} & \multicolumn{2}{|p{12cm}|}{Collaboration} \\\hline
...
\begin{center}
    \begin{tabular}{ |p{3cm}|p{3cm}|p{3cm}|p{3cm}| }
        ...
        \multicolumn{2}{|p{6cm}|}{gestire sospensioni account utente} & \multicolumn{2}{|p{6cm}|}{handleUserBan} \\\hline
        \multicolumn{2}{|p{6cm}|}{gestire sospensioni risorse segnalate} & \multicolumn{2}{|p{6cm}|}{handleProductBan} \\\hline
    \end{tabular}
\end{center}