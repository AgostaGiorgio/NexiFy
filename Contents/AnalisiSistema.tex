...
\begin{center}
    \begin{longtable}{ |p{3cm}|p{3cm}|p{3cm}|p{3cm}| }
        \hline
        Nome & \multicolumn{3}{|p{9cm}|}{HandlerAbbonamenti} \\\hline
        SuperClassi & \multicolumn{3}{|p{9cm}|}{-} \\\hline
        SottoClassi & \multicolumn{3}{|p{9cm}|}{-} \\\hline
        Attributi & \multicolumn{3}{|p{9cm}|}{-} \\\hline
        \multicolumn{4}{|p{12cm}|}{Responsabilit\'a} \\\hline
        \multicolumn{2}{|p{6cm}|}{Nome} & \multicolumn{2}{|p{6cm}|}{Collaboratore} \\\hline
        \multicolumn{2}{|p{6cm}|}{Crea un nuovo piano di abbonamento} & \multicolumn{2}{|p{6cm}|}{ManagerAbbonamenti, Abbonamento} \\\hline
        \multicolumn{2}{|p{6cm}|}{Cambia visibilità di un piano di abbonamento} & \multicolumn{2}{|p{6cm}|}{ManagerAbbonamenti, Abbonamento} \\\hline
        \multicolumn{2}{|p{6cm}|}{Aggiunge un servizio a un piano di abbonamento} & \multicolumn{2}{|p{6cm}|}{ManagerAbbonamenti, Abbonamento, Servizio} \\\hline
        \multicolumn{2}{|p{6cm}|}{Rimuove un servizio da un piano di abbonamento} & \multicolumn{2}{|p{6cm}|}{ManagerAbbonamenti, Abbonamento, Servizio} \\\hline
        \multicolumn{2}{|p{6cm}|}{Sottoscrive un piano di abbonamento} & \multicolumn{2}{|p{6cm}|}{UtenteAutenticato, Abbonamento} \\\hline
        \multicolumn{2}{|p{6cm}|}{Disdice un piano di abbonamento} & \multicolumn{2}{|p{6cm}|}{UtenteAutenticato, Abbonamento} \\\hline
        \multicolumn{2}{|p{6cm}|}{Cambia un piano di abbonamento con un altro} & \multicolumn{2}{|p{6cm}|}{UtenteAutenticato, Abbonamento} \\\hline
    \end{longtable}
\end{center}
...
\begin{center} % CLASS %
    \begin{longtable}{ |p{3cm}|p{3cm}|p{3cm}|p{3cm}| }
        ...
        Attributi & \multicolumn{3}{|p{9cm}|}{email, email recupero, hash password, data registrazione, proprietario (Persona)} \\\hline
        \multicolumn{4}{|p{12cm}|}{Responsabilit\'a} \\\hline %%% RESPONSABILITA %%%
        \multicolumn{2}{|p{6cm}|}{Nome} & \multicolumn{2}{|p{6cm}|}{Collaboratore} \\\hline %%%%%%%
        \multicolumn{2}{|p{6cm}|}{-} & \multicolumn{2}{|p{6cm}|}{-} \\\hline
    \end{longtable}
...
\begin{center} % HANDLER %
    \begin{longtable}{ |p{3cm}|p{3cm}|p{3cm}|p{3cm}| }
        ...
        \multicolumn{4}{|p{12cm}|}{Responsabilit\'a} \\\hline %%% RESPONSABILITA %%%
        \multicolumn{2}{|p{6cm}|}{Nome} & \multicolumn{2}{|p{6cm}|}{Collaboratore} \\\hline %%%%%%%
        \multicolumn{2}{|p{6cm}|}{aggiungi abbonamenti} & \multicolumn{2}{|p{6cm}|}{AccountUtente, HandlerSottoscriviAbbonamento} \\\hline
