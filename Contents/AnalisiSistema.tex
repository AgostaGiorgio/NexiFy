...
\begin{center}
    \begin{tabular}{ |p{3cm}|p{3cm}|p{3cm}|p{3cm}| }
        ...
        \multicolumn{2}{|p{6cm}|}{gestire sospensioni account utente} & \multicolumn{2}{|p{6cm}|}{handlerSospensioni} \\\hline
    \end{tabular}
\end{center}
...
\begin{center}
    \begin{tabular}{ |p{3cm}|p{3cm}|p{3cm}|p{3cm}| }
        ...
        \multicolumn{2}{|p{6cm}|}{calcola età minima per visionare } & \multicolumn{2}{|p{6cm}|}{-} \\\hline
    \end{tabular}
\end{center}
