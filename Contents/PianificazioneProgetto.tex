...
Obbiettivi & 
	\begin{compactitem}
		...
		\item Individuare 5 requisiti funzionali fondamentali (che verranno usati per testare l'architettura)
...
Obbiettivi & 
	\begin{compactitem}
		\item I requisiti fondamentali sono stati individuati e descritti correttamente
		\item Vengono descritti dettagliatamenti gli attori coinvolti nel sistema
...
Obbiettivi & 
	\begin{compactitem}
		...
		\item Individuare il restante 50\% dei requisiti funzionali primari
...
Obbiettivi & 
	\begin{compactitem}
		...
		\item Individuare il 50\% dei requisiti funzionali primari
		...
		\item Individuare i primi test sull'architettura
...
Obbiettivi & 
	\begin{compactitem}
		...
		\item Implementare i casi d'uso fondamentali individuati
...
Obbiettivi & 
	\begin{compactitem}
		...
		\item Implementare l'architettura
		\item Ultimare i test sull'architettura
	\end{compactitem}\\\hline
Stato &  Programmata \\\hline
\end{tabular}
\label{table:7}\newline
...
Obbiettivi & 
	\begin{compactitem}
		...
		\item \'E stata effettuata una stima dei costi attendibile (basata sui requisiti non funzionali e funzionali primari)
...
Obbiettivi & 
	\begin{compactitem}
		...
		\item Definire il modello dei casi d'uso per il 30\% dei requisiti funzionali primari
		...
		\item Implenetazione e definizione dei test per il 30\% dei requisiti funzionali primari
...
Obbiettivi & 
	\begin{compactitem}
		%\item Creazione di un diagramma architetturale dell'intero sistema
		\item Definire il modello dei casi d'uso per un altro 30\% dei requisiti funzionali primari
...
Obbiettivi & 
	\begin{compactitem}
		...
		\item individuazione e descrizione dettagliata dei requisiti funzionali secondari
		%\item Estensione del modello di design (a partire da quello di analisi) e implementazione per il restante 50\% dei requisiti secondari
		%\item Realizzazione dei test per il restante 50\% dei requisiti secondari implementati
...
Obbiettivi & 
	\begin{compactitem}
		%\item Creazione di un diagramma architetturale dell'intero sistema
		\item Definire il modello dei casi d'uso per il restante 10\% dei requisiti funzionali primari
		...
		\item Implenetazione e definizione dei test per il 10\% dei requisiti funzionali primari
		...
		\item Implenetazione e definizione dei test dei requisiti funzionali secondari
		%\item Estensione del modello di design (a partire da quello di analisi) e implementazione per il restante 50\% dei requisiti secondari
		%\item Realizzazione dei test per il restante 50\% dei requisiti secondari implementati
