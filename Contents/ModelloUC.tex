...
Flusso &    \vspace{-5mm} \begin{enumerate}
		...
		\item Il sistema presenta la pagina di gestione dei piani di abbonamento (usando UC\_3), mostrando per ognuno le azioni possibili su di esso
...
Flusso &  	\vspace{-5mm} \begin{enumerate}
		\item Il sistema mostra la lista dei servizi che possono essere aggiunti al piano di abbonamento indicato		
			\begin{enumerate}[label*=\arabic*.]
			\item (UC\_4) Il sistema recupera tutti i servizi disponibili
			\item (UC\_9) Il sistema recupera tutti i servizi associati al piano di abbonamento indicato
...
Flusso &  	
		...
		\item Il sistema, alla fine di ogni mese, recupera la lista degli utenti che possono ricevere un pagamento
			...
			\item (UC\_10) per ogni utente il sistema recupera i suoi piani di abbonamento e da questi (UC\_9) recupera i servizi dell'utente
		...
		\begin{enumerate}[label*=\arabic*.]
			...
			\item (UC\_12) Il sistema calcola l'importo da pagare all'utente
			\begin{enumerate}[label*=\arabic*.]
				\item \textbf{\# alt1}: Se UC\_12 non produce errori, allora il sistema richiede al sistema di pagamento di effettuare un pagamento all'utente (con i dati inseriti dall'utente e l'importo calcolato dal sistema)
				\begin{enumerate}[label*=\arabic*.]
				...
				\end{enumerate}
				\item \textbf{\# alt2}: Se UC\_12 produce errori, viene inviata una mail all'utente comunicandogli che un tentativo di pagamento non è andato a buon fine
			\end{enumerate}
		\end{enumerate}
		\end{enumerate}\\\hline
\end{tabular}
...
Flusso &    \vspace{-5mm} \begin{enumerate}
		...
		\item Il sistema presenta la pagina di gestione dei piani di abbonamento attivi (usando UC\_3), mostrando per ognuno le azioni possibili su di esso
...
Flusso &    \vspace{-5mm} \begin{enumerate}
		...
		\item Il sistema presenta la lista delle segnalazioni, con un pannello per filtrarle
...
Post-condizioni & Nessuna\\\hline
Flusso &  	\vspace{-5mm} \begin{enumerate}
			\item \textbf{\#alt1}: Se il prodotto indicato è un prodotto video, viene riprodotto con (UC\_25)
			\item \textbf{\#alt2}: Se il prodotto indicato è un prodotto musicale, viene riprodotto con (UC\_26)
			\end{enumerate}
			\\\hline
\end{tabular}
\label{table_use_case:\lastUC}\newline
...
Flusso &  \vspace{-5mm}	\begin{enumerate}
		...
		\item Il sistema per ogni prodotto associato alla playlist scelta dall'utente, lo aggiunge alla coda di riproduzione (UC\_40);
...
Flusso &    \vspace{-5mm} \begin{enumerate}
	...
	\item Il prodotto viene riprodotto con UC\_28
