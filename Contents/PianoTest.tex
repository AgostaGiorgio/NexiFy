...
\begin{table}[hb]
    ...
    \begin{tabular}{ |p{2cm}|p{10cm}|  }
        ...
        TEST1:
        \begin{enumerate}[nosep, topsep=0pt]
            \item richiedere di modificare le informazioni di base di un prodotto \emph{contenuto\_p\_v}, fornendo \emph{DESC, GEN};
            ...
            \item verificare che il sistema mostri la pagina riepilogativa con le 
        \end{enumerate}
        \vspace{0.5cm} TEST2:
...
\begin{table}[hb]
    ...
    \begin{tabular}{ |p{2cm}|p{10cm}|  }
        ...
        TEST1:
        \begin{enumerate}[nosep, topsep=0pt]
            \item richiedere la rimozione di \emph{commento\_v}
            \item verificare che il sistema ritorni il messaggio di avvenuta cancellazione di \emph{commento\_v};
        \end{enumerate}
        \\\hline
    \end{tabular}
\end{table}
...
\begin{table}[hb]
    ...
    \begin{tabular}{ |p{2cm}|p{10cm}|  }
        ...
        TEST1:
        \begin{enumerate}[nosep, topsep=0pt]
            \item richiedere l'attivazione di \emph{piano\_abb\_v}
