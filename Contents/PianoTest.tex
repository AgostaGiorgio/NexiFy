...
\begin{itemize}
    ...
    \item AccountUtente utente\_new
    \item Stringa nome
    \item Stringa cognome
    \item Email email
    \item Stringa password
...
\begin{table}[hb]
    ...
    \begin{tabular}{ |p{2cm}|p{10cm}|  }
        ...
        Prerequsiti & L'esecuzione del test è effettuata con privilegi di Amministratore e \emph{utente} è un account bloccato \\\hline
        Tipologia   & White box                                                                                                 \\\hline
        Azioni      &
        TEST1:
        \begin{enumerate}[nosep, topsep=0pt]
...
\begin{table}[hb]
    ...
    \begin{tabular}{ |p{2cm}|p{10cm}|  }
        ...
        TEST1:
        \begin{enumerate}[nosep, topsep=0pt]
            \item richiedere la registrazione di un nuovo account utente, fornendo: \emph{nome, cognome, email, password};
            \item verificare che il sistema crei un account utente \emph{utente\_new} con i dati forniti;
            \item verificare che il sistema ritorni una pagina mostrando "utente registrato con successo";
        \end{enumerate}
        \vspace{0.5cm} TEST2:
        \begin{enumerate}[nosep, topsep=0pt]
            \item richiedere la registrazione di un nuovo account utente, fornendo: \emph{nome, cognome, email\_utente, password};
