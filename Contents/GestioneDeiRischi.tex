...
\begin{tabular}{|p{2.2cm}|p{9.6cm}| }
	...
	\hline
	\textbf{Trigger} & - La gestione dei problemi sorti prova uno slittamento dei tempi che non permette di ultimare il lavoro prefissato nell'iterazione corrente\\
	\hline
...
\begin{tabular}{|p{2.2cm}|p{9.6cm}| }
	...
	\hline
	\textbf{Trigger} & - Nuovi costi emergono rispetto a quelli precedentemente stabiliti\newline
